export default function GetSimulationProjectDetails() {
    return {
        ...
        screenshots: [
            "../assets/Simulation/Screenshot1.png",
            "../assets/Simulation/Screenshot2.png",
            "../assets/Simulation/Screenshot3.png",
            "../assets/Simulation/chopping wood screenshot.png",
            "../assets/Simulation/crafting screenshot.png",
            "../assets/Simulation/gardening screenshot.png"
        ],
        screenshotAlts: [
